...
\begin{table}[h!] % [h!] is a placement specifier: 'here' if possible
    ...
    \caption{Models performances for fully supervised binary classification} % Your table caption
    \label{tab:fully_binary_perf} % A unique label for referencing this table later
