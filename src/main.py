...
if __name__ == "__main__":
    ...
    match experiment_number:
        ...
        case 1:
            ...
            print("\n Loading model...")
            model = get_ResNet50_model(binary_classification=True, freeze_backbone=True, num_layers=num_layers)
            ...
            test_loss, test_acc = evaluate_model(model, device, test_loader, criterion, binary_classification=True)
            print("\nFinal Test Results:")
        ...
        case 2:
            ...
            print(" Loading model..")    
            model = get_ResNet50_model(binary_classification=False, freeze_backbone=False, num_train_layers=num_train_layers)
            
            model, history = train_model_with_adam(model, device, train_loader, val_loader, binary_classification=False, num_epochs=2)
            
            # Print final test results
            criterion = nn.CrossEntropyLoss()
            test_loss, test_acc = evaluate_model(model, device, test_loader, criterion, binary_classification=False)
            print("\nFinal Test Results:")
            print(f'Test Loss: {test_loss:.4f}, '
